            ...
            <div class="wrapper-item">
                ...
                <div class="content-wrapper">
                    ...
                    <div>
                        ...
                        <a href="/LaundryMgtApp/client/viewdetails.php?id=<?php echo $LAUNDRYID ?>">
                            <button class="adminbutton">View Items</button>
                        </a>
                    </div>
                </div>
            </div>
